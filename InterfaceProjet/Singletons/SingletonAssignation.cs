//using InterfaceAssignation.Singletons;
...
//        public void getAssignationsDisponibles()
//        {
...
//                cmd.CommandText = "SELECT * FROM vue_Assignations_disponibles";
...
//                            "",                  // photo_url
//                            r.GetString("statut_Assignation")
//                        );
...
//            }
//        }
//        public void getAssignationsNonDisponibles()
//        {
//            listeAssignation.Clear();
...
//                using MySqlConnection con = new MySqlConnection(connectionString);
//                using MySqlCommand cmd = con.CreateCommand();
//                cmd.CommandText = "SELECT * FROM vue_Assignations_non_disponibles";
...
//        public void AjouterAssignation(
//    string nom,
//    string prenom,
...
//        public int getNombreAssignations()
//        {
...
//                commande.CommandText = "select count(*) from Assignation";
//                con.Open();
...
//            }
//        }
//        //ajoute un Assignation dans la liste
...
//                getAssignationsDisponibles();
//                getAssignationsNonDisponibles();
//            }
//            catch (MySqlException ex)
//            {
//                Debug.WriteLine("Erreur MySQL : " + ex.Message);
...
//            {
//                using MySqlConnection con = new MySqlConnection(connectionString);
//                using MySqlCommand cmd = new MySqlCommand("ModifierAssignation", con);
//                cmd.CommandType = System.Data.CommandType.StoredProcedure;
...
//        public void SupprimerAssignation(string matricule)
//        {
//            try
//            {
//                using MySqlConnection con = new MySqlConnection(connectionString);
//                using MySqlCommand cmd = new MySqlCommand("SupprimerAssignation", con);
//                cmd.CommandType = System.Data.CommandType.StoredProcedure;
...
//        public void RechercherAssignationsTout(string motCle)
//        {
//            listeAssignation.Clear();
...
//            {
//                using MySqlConnection con = new MySqlConnection(connectionString);
//                using MySqlCommand cmd = new MySqlCommand("RechercherAssignationsTout", con);
//                cmd.CommandType = System.Data.CommandType.StoredProcedure;
